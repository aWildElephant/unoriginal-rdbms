...
import static fr.awildelephant.rdbms.execution.arithmetic.AddExpression.addExpression;
import static fr.awildelephant.rdbms.execution.arithmetic.AndExpression.andExpression;
import static fr.awildelephant.rdbms.execution.arithmetic.BetweenExpression.betweenExpression;
import static fr.awildelephant.rdbms.execution.arithmetic.CaseWhenExpression.caseWhenExpression;
import static fr.awildelephant.rdbms.execution.arithmetic.CastExpression.castExpression;
import static fr.awildelephant.rdbms.execution.arithmetic.ConstantExpression.constantExpression;
import static fr.awildelephant.rdbms.execution.arithmetic.DivideExpression.divideExpression;
import static fr.awildelephant.rdbms.execution.arithmetic.EqualExpression.equalExpression;
import static fr.awildelephant.rdbms.execution.arithmetic.ExtractYearExpression.extractYearExpression;
import static fr.awildelephant.rdbms.execution.arithmetic.GreaterExpression.greaterExpression;
import static fr.awildelephant.rdbms.execution.arithmetic.GreaterOrEqualExpression.greaterOrEqualExpression;
import static fr.awildelephant.rdbms.execution.arithmetic.InExpression.inExpression;
import static fr.awildelephant.rdbms.execution.arithmetic.IsNullExpression.isNullExpression;
import static fr.awildelephant.rdbms.execution.arithmetic.LessExpression.lessExpression;
import static fr.awildelephant.rdbms.execution.arithmetic.LessOrEqualExpression.lessOrEqualExpression;
import static fr.awildelephant.rdbms.execution.arithmetic.LikeExpression.likeExpression;
import static fr.awildelephant.rdbms.execution.arithmetic.MultiplyExpression.multiplyExpression;
import static fr.awildelephant.rdbms.execution.arithmetic.NotEqualExpression.notEqualExpression;
import static fr.awildelephant.rdbms.execution.arithmetic.NotExpression.notExpression;
import static fr.awildelephant.rdbms.execution.arithmetic.OrExpression.orExpression;
import static fr.awildelephant.rdbms.execution.arithmetic.OuterQueryVariable.outerQueryVariable;
import static fr.awildelephant.rdbms.execution.arithmetic.SubstringExpression.substringExpression;
import static fr.awildelephant.rdbms.execution.arithmetic.SubtractExpression.subtractExpression;
