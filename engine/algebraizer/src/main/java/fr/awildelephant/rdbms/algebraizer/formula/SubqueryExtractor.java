...
public final class SubqueryExtractor extends DefaultFormulaRewriter {
    ...
    public AST visit(In in) {
        ...
        final Select aliasedRewrittenInValue = new Select(List.of(columnAlias(unqualifiedColumnName(columnName), inValuesColumnAlias)), rewrittenInValue, null, null, null, null);
