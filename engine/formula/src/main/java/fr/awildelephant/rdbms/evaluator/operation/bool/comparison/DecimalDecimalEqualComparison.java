...
final class DecimalDecimalEqualComparison extends Comparison<Operation, BigDecimal, Operation, BigDecimal> {

    DecimalDecimalEqualComparison(final Operation left, final Operation right) {
