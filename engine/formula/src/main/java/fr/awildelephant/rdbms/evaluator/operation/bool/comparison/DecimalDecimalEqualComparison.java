...
final class DecimalDecimalEqualComparison extends Comparison<DecimalOperation, BigDecimal, DecimalOperation, BigDecimal> {

    DecimalDecimalEqualComparison(final DecimalOperation left, final DecimalOperation right) {
