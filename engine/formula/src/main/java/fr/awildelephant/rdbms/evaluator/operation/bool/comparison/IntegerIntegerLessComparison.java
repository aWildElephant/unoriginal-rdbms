...
final class IntegerIntegerLessComparison extends Comparison<IntegerOperation, Integer, IntegerOperation, Integer> {

    IntegerIntegerLessComparison(final IntegerOperation left, final IntegerOperation right) {
