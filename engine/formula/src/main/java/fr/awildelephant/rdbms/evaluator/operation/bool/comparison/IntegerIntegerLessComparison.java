...
final class IntegerIntegerLessComparison extends Comparison<Operation, Integer, Operation, Integer> {

    IntegerIntegerLessComparison(final Operation left, final Operation right) {
