...
public final class DecimalAddition extends BinaryOperation<DecimalOperation, DecimalOperation> implements DecimalOperation {

    public DecimalAddition(final DecimalOperation left, final DecimalOperation right) {
        super(left, right);
    }
