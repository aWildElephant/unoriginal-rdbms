...
public final class AnyAggregate extends AbstractAggregate {

    private final ColumnReference input;

    public AnyAggregate(ColumnReference input, ColumnReference output) {
        super(output);
        this.input = input;
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof final AnyAggregate other)) {
            return false;
        }
