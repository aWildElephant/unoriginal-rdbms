...
import fr.awildelephant.rdbms.execution.operator.join.LeftJoinOutputCreator;
...
public class LeftJoinOperator implements Operator {
    ...
    public LeftJoinOperator(String leftInputKey, String rightInputKey, Schema outputSchema, ValueExpression joinSpecification) {
    ...
    public Table compute(TemporaryStorage storage) {
        ...
        return operator.compute(leftInputTable);
    }
