...
Feature: TPC-H Q18
  ...
  Scenario: I execute TPC-H Q18
    ...
    # Retrieved from https://github.com/apache/impala/blob/master/testdata/workloads/tpch/queries/tpch-q18.test
    Then I expect the result
      | c_name             | c_custkey | o_orderkey | o_orderdate | o_totalprice | sum(l_quantity) |
      | TEXT               | INTEGER   | INTEGER    | DATE        | DECIMAL      | DECIMAL         |
